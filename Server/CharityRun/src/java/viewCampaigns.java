 ...
 * @author PARASP
 */
public class viewCampaigns extends HttpServlet {
 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           // rs2.close();
            ...
            ResultSet rs3 = stmt3.executeQuery("select * from campaigns where status='íncomplete' and campaign_by='"+name+"' order by timestamp desc ");
            int i = 1;
